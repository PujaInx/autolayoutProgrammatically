...
extension Recipe {
    ...
    static func loadRecipes() -> [Recipe] {
        ...
        guard let fileContents = NSArray.init(contentsOf:cookbookURL) as? [[String:String]] else { fatalError("Unable to load cookbook plist.") }
...
//            }
            ...
            return Recipe(title: title, identifier: identifier, description: "")
        }
